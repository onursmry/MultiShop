...
public class _PartialProductDetailDescriptionComponent : ViewComponent
{
    private readonly IHttpClientFactory _httpClientFactory;
    private readonly string _baseUrl = "https://localhost:44359/api/ProductDetails";

    public _PartialProductDetailDescriptionComponent(IHttpClientFactory httpClientFactory)
    {
